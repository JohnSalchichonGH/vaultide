...
5. **Phase-3 rolling windows are `TrackedTotalSpending`, over calendar months.**
   ...
   their months, and month-to-date never contributes (8.6).
...
No genuine blockers remain. The blueprint was frozen as v2.1.2 and Phase 0 began from it; it is frozen as v2.1.16 after the corrections in 30.6, 30.7, 30.8, 30.9, 30.10, 30.11, 30.12, 30.13, 30.14, 30.15, 30.16, 30.17, 30.18 and 30.19, none of which changed a phase already delivered.
...
- No remaining blocker was found. The blueprint is frozen as v2.1.16.
